                                    ...
                                    "curves": [
                                        {
                                            ...
                                            "data": [{"depth": 1598.3, "RHOB": 2.2322}, {
                                                ...
                                                "depth": 1598.8,
                                                "RHOB": 2.447
                                            }, {"depth": 1598.9, "RHOB": 2.598}, {
                                                "depth": 1599,
                                                "RHOB": 2.8088
                                            }, {"depth": 1599.1, "RHOB": 2.2248}, {
                                                "depth": 1599.2,
                                                "RHOB": 2.2399
                                            }, {"depth": 1599.3, "RHOB": 2.251}, {
                                                "depth": 1599.4,
                                                "RHOB": 2.255
                                            }, {"depth": 1599.5, "RHOB": 2.2526}, {
                                                "depth": 1599.6,
                                                "RHOB": 2.2322
                                            }, {"depth": 1599.7, "RHOB": 2.2513}, {
                                                "depth": 1599.8,
                                                "RHOB": 2.2548
                                            }, {"depth": 1599.9, "RHOB": 2.2445}, {
                                                "depth": 1600,
                                                "RHOB": 2.2223
...
//   let x_for_k_is_3
                    ...
                    /**
                     * This function is used to plot a single curvebox in the div listed in the plotting templates div_id key.
...
//// Function that checks if a temp_json exists. If it does, it allows divs that manipulate that JSON to show
        function checkForJSONThenCollapse(divID) {
            ...
            if (!temp_json['WELL INFORMATION BLOCK']) {
                "button did nothing because well JSON doesn't exist"
            } else {
...
// Like d3.local, but with the name “__brush” rather than auto-generated.
    ...
    }, {"d3-dispatch": 15, "d3-drag": 16, "d3-interpolate": 24, "d3-selection": 31, "d3-transition": 36}],
...
// Ignore right-click, since that should open the context menu.
    ...
    }, {"d3-dispatch": 15, "d3-selection": 31}],
...
// https://d3js.org/d3-force/ v1.2.1 Copyright 2019 Mike Bostock
    ...
    }, {"d3-collection": 12, "d3-dispatch": 15, "d3-quadtree": 27, "d3-timer": 35}],
...
// https://d3js.org/d3-transition/ v1.3.2 Copyright 2019 Mike Bostock
    ...
    }, {"d3-color": 13, "d3-dispatch": 15, "d3-ease": 18, "d3-interpolate": 24, "d3-selection": 31, "d3-timer": 35}],
