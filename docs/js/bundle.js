...
help:function(){
  ...
  */
  ...
  console.log("depth_curve_name",depth_curve_name  )
  console.log("well_log_json",well_log_json  )
  console.log("well_log_json",well_log_json  );
...
},{"d3":39}],4:[function(require,module,exports){
...
function reformatJSONforPlotting(temp_json,curve,div){
    ...
    ///////////
    wellDataForPlotting = wellioviz.fromJSONofWEllGetThingsForPlotting(temp_json,generic_template["depth_curve_name"])
